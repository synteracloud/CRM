/* Pakistan CRM — Deals Page Driver */
/* Source: src/assets/js/dashboard/deals.js — all configs verbatim */

/* ── 1. dt_NewCustomers DataTable (from FRAMEWORK.md §24 / deals.js) ──── */
...
/* ── 2. chartDeals — Deals Value Trend (ApexCharts area, tab switching) ── */
...
/* ── 3. chartDealPipeline — Deal Pipeline (ApexCharts dual-axis bar) ───── */
