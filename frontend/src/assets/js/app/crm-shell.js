        ...
        <div class="tab-pane fade show active" id="dashboardTab" role="tabpanel" tabindex="0">
          <nav class="app-navbar" data-simplebar>
            <ul class="side-menubar">
              ...
              <li class="menu-item"><a class="menu-link${a(['tasks'])}" href="app/task-management.html" role="button"><svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="20" height="20" rx="6" fill="var(--bs-danger)" /></svg><span class="menu-label">Tasks &amp; Projects</span></a></li>
              <li class="menu-item"><a class="menu-link${a(['user-management'])}" href="app/user-management.html" role="button"><svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="20" height="20" rx="6" fill="var(--bs-info)" /></svg><span class="menu-label">User Management</span></a></li>
              <li class="menu-item"><a class="menu-link${a(['activities'])}" href="app/activities.html" role="button"><svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="20" height="20" rx="6" fill="var(--bs-warning)" /></svg><span class="menu-label">Activities</span></a></li>
