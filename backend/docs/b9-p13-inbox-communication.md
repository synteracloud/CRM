...
Anchored to `docs/whatsapp-execution-model.md`, `docs/pakistan-adapter-architecture.md`, `adapters/pakistan/messaging/`.
...
**Source doc:** `docs/whatsapp-execution-model.md`
...
**Source doc:** `docs/whatsapp-execution-model.md` §10 (intent detection) + §11 (anti-lead-loss)
