<!-- OWNERSHIP
PRIMARY FOR: Onboarding UX flow; first-run experience spec; adoption metrics (DAU/WAU retention targets).
DEFERS TO: activation-model.md (aha-moment definition); followup-enforcement-model.md (enforcement phase labels).
DO NOT RE-DEFINE: Aha-moment definition → activation-model.md; enforcement phase labels → followup-enforcement-model.md §1.2.
-->
...
| Topic | Document |
|---|---|
| Zero-setup onboarding (technical) | `docs/product/activation-model.md` |
| ≤2 steps interaction rule | `docs/ui/ui-foundations.md §6` |
| Gradual enforcement model | `docs/domain/followup-enforcement-model.md §1.2` |
| Next action suggestion | `docs/domain/followup-enforcement-model.md §2 — D. Next Action Suggestion` |
| Anti-lead loss guarantee | `docs/adapters/whatsapp-execution-model.md §11` |
| Shadow tracking | `docs/domain/activity-control-model.md §8.1` |
| Bilingual + localization | `docs/adapters/pakistan-adapter-architecture.md §3.E, §3.F` |
| Mobile-first + low bandwidth | `docs/infrastructure/offline-sync.md §13`, `docs/_b9/b9-p08-mobile-responsiveness-system.md` |
