...
Configuration is set in tenant settings (see `docs/b9-p09-settings-admin.md`). If all targets are unavailable (users inactive/suspended), the lead is flagged as `unassignable` on the owner dashboard and requires manual intervention.
