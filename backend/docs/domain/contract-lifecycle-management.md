<!-- OWNERSHIP
PRIMARY FOR: Contract lifecycle states and transitions; contract API; approval and signing workflows.
DEFERS TO: domain-model.md (base Contract entity field list — this file adds lifecycle context only).
DO NOT RE-DEFINE: Contract entity fields → domain-model.md.
-->
