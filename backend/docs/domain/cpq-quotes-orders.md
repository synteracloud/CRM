<!-- OWNERSHIP
PRIMARY FOR: Quote → Order lifecycle transitions; CPQ API surface; approval workflow rules; discount constraints.
DEFERS TO: domain-model.md (Quote and Order entity field lists); event-catalog.md (quote/order event names).
DO NOT RE-DEFINE: Quote + Order field schemas → domain-model.md (this file adds lifecycle context only).
-->
