...
| Overdue 0–30 days | `InvoiceAgingReadModel` |
| Overdue 31–60 days | `InvoiceAgingReadModel` |
| Overdue 60+ days | `InvoiceAgingReadModel` |
...
- Role: `Tenant Owner` or `Manager` (see [`identity-auth-rbac.md`](identity-auth-rbac.md))
...
| KPI aggregates (win rate, DSO) | Every 15 minutes (batch aggregation) | KPI pipeline (see [`kpi-data-pipelines.md`](kpi-data-pipelines.md)) |
...
See [`b9-p08-mobile-responsiveness-system.md`](b9-p08-mobile-responsiveness-system.md).

---

## 8) Related Documents

- [`read-models.md`](read-models.md) — read model definitions powering dashboard panels
- [`kpi-data-pipelines.md`](kpi-data-pipelines.md) — KPI computation logic
...
- [`b9-p03-sales-cockpit.md`](b9-p03-sales-cockpit.md) — rep-level execution surface (distinct from Owner Dashboard)
