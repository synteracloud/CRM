<!-- OWNERSHIP
PRIMARY FOR: Feature-to-service mapping — which capability is delivered by which service.
DEFERS TO: service-map.md (service names); domain-model.md (capability labels).
DO NOT RE-DEFINE: Service internals; entity schemas.
-->
