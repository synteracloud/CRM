...
Existing coverage:
- Workflow Visual Builder → `docs/_b9/b9-p07-workflow-visual-ui.md`
- Campaign Journey Builder → `docs/_b9/b9-p05-marketing-workspace.md`
- Opportunity Pipeline Board + Lead Pipeline Board → `docs/_b9/b9-p03-sales-cockpit.md`
...
**Source:** Custom Object Framework — `docs/domain/custom-object-framework.md`, `b9-p09-settings-admin.md §2.8`
...
- Relation fields must reference a valid entity from `docs/architecture/domain-model.md`.
...
**Source:** `docs/domain/cpq-quotes-orders.md`
