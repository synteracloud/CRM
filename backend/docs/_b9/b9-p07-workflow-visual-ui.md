...
This specification defines a **visual workflow builder UX model** that is a strict projection of `docs/infrastructure/workflow-dsl.md` and remains semantically aligned with `docs/infrastructure/workflow-catalog.md` canonical sequences.
...
2. Re-check: verified against `docs/infrastructure/workflow-dsl.md` required fields/validation and `docs/infrastructure/workflow-catalog.md` canonical sequencing semantics.
3. Score: **10/10**.
