...
This specification defines responsive behavior for the CRM platform UI using the capability set in `docs/architecture/capability-matrix.md` as the functional baseline. It ensures mobile and tablet usability for high-frequency and high-business-impact workflows: lead intake, opportunity updates, quote approvals, case triage, search, and dashboards.
