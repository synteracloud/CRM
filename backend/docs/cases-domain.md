...
| `case.sla.first_response_breached` | First-response deadline missed. |
| `case.sla.resolution_breached` | Resolution deadline missed (emitted at each escalation level threshold: 25%, 50%, 100%). |
