...
# SLA health states — referenced by support_console QueueItem.sla_state
# healthy  : both response_due_at and resolution_due_at are in the future with buffer
# at_risk  : within 20% of SLA window remaining — proactive escalation triggered
# breached : SLA due time has passed without resolution
SlaState = Literal["healthy", "at_risk", "breached"]

# Escalation action types — see EscalationRule.route_to and support_console EscalationControl
EscalationActionType = Literal["reassign", "raise_priority", "page_on_call", "request_manager_review"]
