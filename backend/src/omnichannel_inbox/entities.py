...
# Supported communication channels — must match messaging_db channel_type CHECK constraint
ChannelType = Literal["whatsapp", "email", "sms", "in_app", "voice"]

# Thread lifecycle states
ThreadStatus = Literal["open", "active", "pending_customer", "resolved", "closed", "archived"]
