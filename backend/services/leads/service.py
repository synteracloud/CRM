...
class WhatsAppLeadCaptureService:
    ...
    def capture_inbound_message(
        ...
        *,
        ...
        # Docs: BEHAV-001 — intent classifier must fire on every inbound message.
        # Auto-classify if caller did not pre-classify (e.g. webhook handler).
        if not classified_intent:
            result = classify_intent(
                message_body=getattr(message, "text", "") or "",
