> **RETIRED** — This document has been superseded by [runtime-deployment.md](../backend/docs/infrastructure/runtime-deployment.md) and [RENDER-DEPLOY.md](../reference/RENDER-DEPLOY.md).
