...
> **Purpose Statement:** This file governs the commercialisation phases (C0–C6). For the definitive statement of what this SaaS is, who it serves, and why it exists, see [PROJECT_CHARTER.md](docs/00_authority/PROJECT_CHARTER.md) (docs/00_authority/). The intro summary in this file is an operational anchor, not the primary purpose statement.
> Cross-reference added: 2026-06-21 (Documentation Normalization Phase — DUP-007 resolution)
...
**Task tracker:** `docs/reports/session/PENDING.md` — add commercialisation tasks here as `[ ]` items under a new `## Commercialisation` section
**Session log:** `docs/reports/session/PROGRESS.md` — one-line summary added every session
...
**First file to open every session:** `docs/reports/session/SYSTEM-SNAPSHOT.md` → this file → `docs/reports/session/PENDING.md` Commercialisation section
...
| C5 | Post-Deploy Smoke + Production Sign-Off | ✓ COMPLETE 2026-06-02 — all production gates pass |
...
1. Read `docs/reports/session/SYSTEM-SNAPSHOT.md` — 60-second orientation: what is built, what is next
2. Read this file — confirm current phase from the RESUME POINT table above
3. Read `docs/reports/session/PENDING.md` Commercialisation section — find first unchecked `[ ]`
4. Verify C0 seal is active (run `.env.local` loader — see C0 §Step 4)
5. Execute the task

**Session close (mandatory before ending every session):**
1. Mark completed tasks `[x]` in `docs/reports/session/PENDING.md`
2. Update RESUME POINT table above — correct current phase
3. Update **Status** line at the top of this file
4. Add one-line summary to `docs/reports/session/PROGRESS.md`
...
| Every new `.md` file catalogued in `docs/reports/u-series/DOC_CATALOGUE.md` same day it is written | `docs/reports/u-series/DOC_CATALOGUE.md` rule |
...
Add `## [1.0.0] — YYYY-MM-DD — Commercial launch` to `docs/reports/session/CHANGELOG.md` with summary of C0–C6 work.
...
- `docs/reports/session/SYSTEM-SNAPSHOT.md` — final score update, date, C6 complete
- `docs/reports/session/PENDING.md` — all commercialisation tasks marked `[x]`
- `docs/reports/session/PROGRESS.md` — final session summary line
- This file — all phases marked ✓ in RESUME POINT table

### C6 Gate

`git tag v1.0.0` pushed. All CI/CD jobs green on the tagged commit. `docs/reports/session/SYSTEM-SNAPSHOT.md` reflects final scores. `docs/reports/session/PENDING.md` 100% complete.
...
| Document | Purpose |
|---|---|
| `docs/archive/REBUILD-PLAN.md` | **CLOSED** — build phases 1–6 historical record |
| `docs/reports/session/SYSTEM-SNAPSHOT.md` | Current project state — read first every session |
| `docs/reports/session/PENDING.md` | Task checklist — Commercialisation section |
| `docs/reports/session/PROGRESS.md` | Session-by-session log |
| `docs/reports/session/SCREEN-ARTEFACTS.md` | QC records for all 75 custom pages |
...
| `docs/reports/u-series/DOC_CATALOGUE.md` | Master index of all .md files |
